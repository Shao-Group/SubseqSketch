...
public:
    ...
    // Assume sketch2 has NOT been transposed, see rssebd_array::load_all.
    static void pairwise_max_likelyhood_dist(const Eigen::MatrixXi& sketch1,
					     const Eigen::MatrixXi& sketch2,
					     const std::string& dist_file);

    // Assume sketch2 has NOT been transposed and has NOT been normalized, see rssebd_array::load_all.
    static void pairwise_tanimoto_dist(const Eigen::MatrixXi& sketch1,
				       const Eigen::MatrixXi& sketch2,
				       const std::string& dist_file);

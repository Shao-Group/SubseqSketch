...
void compute_distances(const std::string& sketch_file1,
		       ...
		       const std::string& distance_choice,
...
int main(int argc, char** argv)
{
	...
	->default_val("cosine")
	->check(CLI::IsMember({"cosine", "maxlikelyhood", "tanimoto"}));
    ...
    {
	compute_distances(sketch_file1, sketch_file2, distance_choice, dist_file);
    }
		       ...
		       const std::string& dist_file)
{
    ...
    std::cout << "distance_metric: " << distance_choice << std::endl << std::endl;
    ...
    Eigen::MatrixXi sketches1;
    sketches1 = sss_array::load_all(num_sketches1, sketch_dim1, num_tokens1, sketch_file1);
    ...
    Eigen::MatrixXi sketches2;
    sketches2 = sss_array::load_all(num_sketches2, sketch_dim2, num_tokens2, sketch_file2);
    ...
    else if(distance_choice == "maxlikelyhood")
    {
	sss_array::pairwise_max_likelyhood_dist(sketches1, sketches2, dist_file);
    }
    else if(distance_choice == "tanimoto")
    {
	sss_array::pairwise_tanimoto_dist(sketches1, sketches2, dist_file);
    }
